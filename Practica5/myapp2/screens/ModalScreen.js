  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        React Native: Modal y Bottom Sheet
      </Text>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>Clase práctica</Text>
        <Text style={styles.cardText}>Duración de 40 min</Text>
        <Text style={styles.cardText}>
          Modalidad: {selectedMode}
        </Text>
        <Text style={styles.cardText}>
      ...
      <Modal visible={modalVisible} animationType="fade" transparent statusBarTranslucent onShow={() => console.log("Modal de confirmación abierto")} onRequestClose={() => setModalVisible(false)}>
        <View style={styles.overlay}>
          <View style={styles.modalCard}>
            <Text style={styles.modalTitle}>Confirmar reserva</Text>
            <Text style={styles.modalText}>Deseas reservar la clase en modalidad</Text>
      ...
      <BottomSheet visible={sheetVisible} onClose={() => setSheetVisible(false)} title="Elige modalidad" height={330}>
        <Pressable style={styles.optionButton} onPress={() => handleSelectedMode("Presencial")}>
          <Text style={styles.optionTitle}>Presencial</Text>
          <Text style={styles.optionText}>Asiste al salón asignado.</Text>
        </Pressable>

        <Pressable style={styles.optionButton} onPress={() => handleSelectedMode("En línea")}>
          <Text style={styles.optionTitle}>En línea</Text>
          <Text style={styles.optionText}>Recibe el enlace de videollamada.</Text>
        </Pressable>

        <Pressable style={styles.optionButton} onPress={() => handleSelectedMode("Grabación")}>
